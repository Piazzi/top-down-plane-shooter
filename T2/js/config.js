...
export const SPAWN_TYPE_1_ENEMY_INTERVAL = 1500; // milliseconds
export const SPAWN_TYPE_2_ENEMY_INTERVAL = 5000; // milliseconds
export const SPAWN_TYPE_3_ENEMY_INTERVAL = 10000; // milliseconds
export const SPAWN_TYPE_4_ENEMY_INTERVAL = 12000; // milliseconds
...
export const ENEMY_PROJECTILE_SPEED =  0.017;
